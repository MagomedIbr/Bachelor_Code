...
def knn_all_sessions_separately():
    ...
    for sessionID in sessionIDs:
        ...
        print("Classification Accuracy for session " + str(sessionID) + " is " + str(clf.score(X_test, y_test)))
...
def knn_all_users_separately():
    ...
    for user_id in user_ids:
        ...
        clf = GridSearchCV(k_clf, parameter_grid, cv=10)
        clf.fit(X_train, y_train)
        print("Classification Accuracy for user " + str(user_id) + " is " + str(clf.score(X_test, y_test)))
